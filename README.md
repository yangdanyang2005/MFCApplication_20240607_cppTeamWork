...
# 重要提示
如果您直接下载这些代码运行，大概率是无法直接运行的。因为这个项目依赖于作者本人电脑中的 `MySQL` 数据库、 `MATLAB R2024b` 等相关环境，而且由于Github文件上传大小限制，作者没有上传C++ MFC的相关UI界面的文件。  

但是如果您能够理解代码中的内容，在修改少量源代码中的参数、配置相关环境并进行C++ MFC的界面设计后，本项目可以成功运行。  
