...
BEGIN_MESSAGE_MAP(FileReadDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDOK, &FileReadDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDCANCEL, &FileReadDlg::OnBnClickedCancel)
END_MESSAGE_MAP()
...
void FileReadDlg::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	isWantToOpenFile=true;
	CDialogEx::OnOK();
}


void FileReadDlg::OnBnClickedCancel()
{
	// TODO: 在此添加控件通知处理程序代码
	isWantToOpenFile=false;
	CDialogEx::OnCancel();
}
